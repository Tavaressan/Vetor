...
```bash
bash "../../scripts/vetor-checks.sh" debug-scan "origin/$DEFAULT_BRANCH"
```
...
```bash
bash "../../scripts/vetor-merge.sh" <PR-number>
```
...
automaticamente:
```bash
bash "../../scripts/vetor-checks.sh" safe-remove-worktree "<path-do-worktree>"
git branch -d <branch>
